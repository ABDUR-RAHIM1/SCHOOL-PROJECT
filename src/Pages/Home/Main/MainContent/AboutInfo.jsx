...
function AboutInfo() {
  return (
    <>
      <h1 className='heading'>মাদ্রাসা সম্পর্কে</h1>
      <motion.div
      initial={{opacity : 0}}
