...
function Principle() {
    ...
    return (
        <>
            <h1 className='heading text-center'>প্রধান শিক্ষক</h1>
            <motion.div
               initial={{scale : 0.5}}
               whileInView={{scale : 1}} 
               transition={{
